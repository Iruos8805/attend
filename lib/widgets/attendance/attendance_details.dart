...
class _AttendanceListState extends State<AttendanceList> {
  ...
  Future<void> fetchData() async {
    final response = await http.get('https://sabarixr.pythonanywhere.com/api/attedance/{classnameid/{special_id}/' as Uri);
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            ...
            subtitle: Text('Student: ${attendance.name} (ID: ${attendance.uid})'),
          );
        },
      ),
    );
